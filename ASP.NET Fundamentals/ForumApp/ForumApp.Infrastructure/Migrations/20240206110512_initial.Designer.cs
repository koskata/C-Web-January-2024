...
namespace ForumApp.Infrastructure.Migrations
{
    ...
    [Migration("20240206110512_initial")]
            ...
            modelBuilder.Entity("ForumApp.Infrastructure.Data.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Content = "My first post will be about CRUD operations in MVC. It's so much fun!",
                            Title = "My first post"
                        },
                        new
                        {
                            Id = 2,
                            Content = "This is my second post. CRUD operations are getting more and more interesting!",
